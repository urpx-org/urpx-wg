...
_The next regular meeting. The 2026-07-14 session was an additional review of the v0.3.0 candidate._
...
- Feedback on the v0.3.0 candidate received since the 2026-07-14 review session.
- Jeremy Roberts (Green Button Alliance) is reviewing the candidate and is presenting URPX support at the Green Button Alliance board meeting on the 23rd for its consideration.
- Don Jackson's implementation feedback, from building an OpenADR 3 public price server for California retail rate plans on the model.
- Any remaining questions from members' review.

---

### 3. Approval to Publish

- At the 2026-07-14 session the sense of the room was that publication does not require a formal ballot: the LF Energy technical review is complete and v0.3.0 is a reasonable starting point for the public standard.
- This item records the working group's approval to publish v0.3.0 and to proceed with the license conversion and IP scan. The decision is recorded in the minutes.
...
- The converted materials then go through the LF Energy IP scan.
...
- California rate plan examples offered for the model, including the NBT modifier, from the California Energy Commission participants (Shubham and Stefanie, MIDAS).
